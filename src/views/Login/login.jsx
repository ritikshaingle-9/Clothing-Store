 ...
 export default function Login() {
  return (
    <div>
        <div>
            <Navbar/>
            <div className="bg-[#bfd9d2] bg-opacity-50 w-110 h-100 rounded-xl ml-140 mt-20">
                <h1 className="text-center text-2xl font-medium p-3 rounded-t-xl bg-[#1d302b] text-white h-15">SIGN IN</h1>
